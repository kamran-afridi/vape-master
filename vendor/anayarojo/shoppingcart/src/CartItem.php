...
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param array      $options
     */
    public function __construct($id, $name, $price, $sku, $weight = 0, array $options = [])
    {
        if (empty($id)) {
    ...
    public static function fromArray(array $attributes)
    {
        ...
        return new self($attributes['id'], $attributes['name'], $attributes['price'], $attributes['sku'], $attributes['weight'], $options);
    }
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, $sku, $weight, array $options = [])
    {
        return new self($id, $name, $price, $sku, $weight, $options);
    }
