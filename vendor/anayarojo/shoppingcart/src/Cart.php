...
class Cart
{
     ...
     */
    public function add($id, $sku = null, $name = null, $qty = null, $price = null, $weight = 0, array $options = [])
    {
        if ($this->isMulti($id)) {
        ...
        $cartItem = $this->createCartItem($id, $sku, $name, $qty, $price, $weight, $options);
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public function update($rowId, $qty, $price)
    {
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    private function createCartItem($id, $name, $qty, $price,  $sku, $weight, array $options)
    {
        if ($id instanceof Buyable) {
            ...
            $cartItem = CartItem::fromAttributes($id, $name, $price, $sku, $weight, $options);
