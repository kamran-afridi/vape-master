...
class OrderController extends Controller
{
    ...
    public function update_payment_status($uuid, Request $request)
    {
        ...
        return redirect()->route('orders.show', $uuid)->with('success', 'Payment type has been updated!');
    }
    ...
    public function editsubmitedorder($id, Request $request)
    {
        ...
        return redirect()->route('orders.show', $request->uuid)->with('success', 'Order has been Updated!');
    }
    public function update($uuid, Request $request)
    {
        ...
        return redirect()->route('orders.complete')->with('success', 'Order has been completed!');
    }
    ...
    public function deleteitems($orderdetailsid, Request $request)
    {
        ...
        return redirect()->route('orders.show', $request->uuid)->with('success', 'Order has been deleted!');
    }
}
